...
Flashduty already supports the majority of common monitoring systems, including Prometheus, Zabbix, Nightingale, and cloud monitoring. Visit [Alarm Integration](/mixin/alert_integration/nightingale) for detailed steps on how to proceed.
...
Flashduty offers a custom event standard, enabling you to report alerts through a standard protocol, which is applicable to any monitoring systems that are not yet integrated. For more information, refer to [Custom Events](/mixin/alert_integration/custom_alert).
...
Flashduty provides an email integration feature, allowing you to report alerts via email, suitable for all monitoring systems that support email notifications. Detailed instructions can be found in [Custom Events](/mixin/alert_integration/email).
