...
|+| Expand
    ...
    2. Select the **Integrated Data** tab, click on **Add an Integration**, and proceed to the integration creation page
...
|+| Expand
    ...
    4. Click **Create Route** to configure routing rules for the integration. You can match different alerts to different collaboration spaces based on specific conditions, or set a default collaboration space as a fallback, which can be adjusted as required later on.
    5. Completed.
