...
- **Follow Individual Preferences:** Notification methods are set by members independently in the [Account Configuration](/conf/preference_settings) for each alert category's receiving channels and methods.
...
You can also manually upgrade issues by visiting [Upgrade and Dispatch Issues](/alter/escalate_incidents) for more details.
