---
brief: By integrating Feishu's custom applications, the capability to receive and respond to alerts directly within the Feishu platform is realized
---

# Feishu Lark Integration

Through the integration of Feishu's self-developed applications, the functionality to receive and respond to alerts within the Feishu client is achieved.
