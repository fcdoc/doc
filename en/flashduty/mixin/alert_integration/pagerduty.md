...
Flashduty implements the PagerDuty Events API, ensuring full compatibility in inputs and responses. Therefore, you can push alert events to Flashduty through the PagerDuty protocol to achieve automated noise reduction processing of alert events.
...
|+| Expand
    ...
    2. Choose the **PagerDuty** integration:
