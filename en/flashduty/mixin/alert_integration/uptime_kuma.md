...
|+| Expand
    ...
    3. Select the **Uptime Kuma** integration, click **Save**, and generate a card.
...
3. If you need to set tags, you can add `Tags`. Note that only tags with both Key/Value will be pushed to FlashDuty;
