---
brief: Synchronize Graylog alert events to Flashcat via webhook to achieve automated noise reduction processing of alert events
---
...
|+| Expand
    ...
    - Select the **Graylog** integration:
